import{a as b,i as u,S}from"./assets/vendor-C9vNCoLC.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();let O=15;const l=new URLSearchParams({image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:O});b.defaults.baseURL="https://pixabay.com/api/?key=38590711-cd4e1138b2603dfebaf6d7de9&";async function P(r,t=1){return r.length===0?Promise.reject("Sorry, there are no images matching your search query. Please try again!"):(l.set("q",r.trim().toLowerCase()),l.set("page",t),await b.get(l.toString()).then(i=>{if(i.status!==200)throw new Error(i.status);return i.data}).catch(i=>{u.error({message:`${i}`,closeOnClick:!0,position:"topRight",displayMode:0,progressBar:!1})}))}function q(r){return r.map(({comments:o,downloads:i,likes:e,tags:s,largeImageURL:a,previewURL:w,views:C})=>`<li class="gallery-item">
